...
class InboundPackageForm:
	def __init__(self):
		...
		# Receive Package
		Button(base, text='Receive Package', bg='brown', fg='white', command=self.receive_package).grid(row=14, column=0,
		                                                                                                columnspan=4,
		                                                                                                sticky=W + E)
		# Process Logger
		...
		Button(base, text='Clear', bg='white', fg='brown', command=self.delete_contents).grid(row=19, column=3, sticky=W + E)
